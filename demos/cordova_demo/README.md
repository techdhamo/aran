# ARAN RASP Cordova Demo

This is a demo application showcasing the ARAN RASP (Runtime Application Self-Protection) Cordova plugin.

## Features

- **Obfuscated Selectors**: Uses integer selectors (0x1A2B, 0x2B3C, etc.) instead of readable strings
- **Native Bridge Integration**: Direct native access through Cordova plugin
...
2. Navigate to the cordova_demo directory
